  ...
  return (
    <>
      <div className="container__img">
        <img src="../../static/background/waves.png" alt="waves" />
        <img src="../../static/background/fish2.png" alt="fish" className="fish" />
        <img src="../../static/background/fish3.png" alt="fish3" />
      </div>
      <div className="map__container">
        <div style={{ position: 'relative', overflow: 'hidden', borderRadius: '45px', marginBottom: '50px' }}>
          <a
